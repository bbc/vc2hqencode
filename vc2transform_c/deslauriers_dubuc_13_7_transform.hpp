/*****************************************************************************
 * deslaurier_dubuc_13_7_transform.hpp : DD13,7 transform: Plain C++ version
 *****************************************************************************
...
template<class T> void Deslauriers_Dubuc_13_7_transform_H_inplace_10P2(const char *_idata,
                                                                        const int istride,
                                                                        void **_odata,
                                                                        const int ostride,
                                                                        const int iwidth,
  ...
  for (; y < iheight; y+=skip) {
    int x = 0;
    int32_t Dm4, Dm2, Dm1, D, Dp1, Dp2, Dp3, Dp4;
    int Xm5, Xm3, Xm2, Xm1, Xp1;
...

    {
      ...
      Xm5 = Xp1;
      Xm3 = Xm1;
      Xm2 = Dm2 + ((-Xm5 + 9*Xm3 + 9*Xm1 - Xp1 + 16) >> 5);

      odata[y*ostride + x - 2*skip] = Xm2;
      odata[y*ostride + x - 1*skip] = Xm1;
...
template<int skip, class T> void Deslauriers_Dubuc_13_7_transform_H_inplace(void *_idata,
                                                                            const int istride,
                                                                            const int width,
                                                                            const int height,
                                                                            const int) {
  ...
  for (int y = 0; y < height; y+=skip) {
...

    {
      ...
      idata[y*istride + x - 2*skip] = Xm2;
      idata[y*istride + x - 1*skip] = Xm1;
...
template<int skip, class T>void Deslauriers_Dubuc_13_7_transform_V_inplace(void *_idata,
                                                                           const int istride,
                                                                           const int width,
                                                                           const int height,
                                                                           const int) {
